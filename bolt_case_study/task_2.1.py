...
AggregatedData AS (
    SELECT
        ...
        d.Hour,
        `Potential Orders`,
        s.`Deliveries per Hour` * s.`Online Hours` AS Supply
    FROM
        PotentialDemand d
    LEFT JOIN
        df2 s
...
SELECT
    ...
    Supply,
    CASE 
        WHEN `Potential Orders` > Supply THEN 'Undersupplied'
...
output_file = '/Users/abhisheksingh/Downloads/bolt_task_2_3_4.xlsx'
